...
class OneStepBeam:
    ...
    def do_one_step(self, argument_tuple):
        ...
        list_beam_candidates = self.model.decoder.beam_search_decode_inference(
            key, value, seq_len, self.SOS_token, self.EOS_token, self.max_label_len, self.beam_size, self.num_candidates, device='cpu')
