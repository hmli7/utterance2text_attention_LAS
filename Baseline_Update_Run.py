...
output_path = os.path.join(paths.output_path, 'Baseline_Try_1')
...
model_path = os.path.join(output_path, 'baseline_s2s_18.pth.tar')
...
#     param_group['lr'] = 1e-3*0.1
    
# print('lr changed to', 1e-3*0.1)
